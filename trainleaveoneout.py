...
num_folds = 5
use_groups = True #FALSE SI WINDOW LEVEL, TRUE SI LEAVE ONE PACIENT OUT
...
def get_default_hyperparameters():
    ...
    inputmodule_params['n_nodes'] = 2688  # Input size
    
    # LSTM unit parameters
    net_params['Lstacks'] = 1  # Stacked layers (num_layers)
    net_params['dropout'] = 0.0
    net_params['hidden_size'] = 256  # Hidden size
...
# Guardar el modelo
model = model.to("cpu")
torch.save(model.state_dict(), "epilepsy_lstm_pacientout.pth")
print("Model saved")
if WANDB_SET:
    wandb.finish()
torch.cuda.empty_cache()
